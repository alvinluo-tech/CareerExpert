---
name: resume-style
description: 专注简历前端视觉排版、HTML/CSS 调色换肤、版面边距与字号微调、严格单页/双页高度契合 (85%~95% 填充率) 以及无头渲染 PDF。触发词：换颜色、换胶囊风格、调整边距、单页排不下、调成双页、调整字体大小、微调 CSS、渲染 PDF，或快捷指令 /style。
---

# resume-style — 简历视觉工程与排版专精技能
...
- 用户输入 Slash 指令：`/style` 或 `/style-resume`
